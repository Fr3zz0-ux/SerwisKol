      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/polityka-prywatnosci" className="hover:text-[#da291c] transition-colors">Polityka Prywatności</Link>
            <Link href="/regulamin" className="hover:text-[#da291c] transition-colors">Regulamin</Link>
          </div>
        </div>
      </div>
    </footer>

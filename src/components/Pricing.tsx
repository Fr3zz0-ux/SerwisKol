      ...
      <div className="container mx-auto px-4 md:px-6 max-w-5xl relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center mb-12 gap-4 md:gap-6">
          <button
            ...
            className={`flex items-center gap-3 px-8 md:px-12 py-4 rounded-xl font-bold text-sm md:text-base transition-all duration-500 tracking-widest border ${activeTab === "wulkanizacja"
          ...
          <button
            ...
            className={`flex items-center gap-3 px-8 md:px-12 py-4 rounded-xl font-bold text-sm md:text-base transition-all duration-500 tracking-widest border ${activeTab === "klimatyzacja"
                ? "bg-gradient-to-r from-[#da291c] to-[#ff4b3e] text-white shadow-[0_0_30px_rgba(218,41,28,0.3)] border-white/20 scale-105"
                : "bg-white/5 text-gray-400 hover:text-white hover:bg-white/10 border-transparent hover:border-white/10"
              }`}
          >
              ...
              <div className={`min-w-[600px] md:min-w-[800px]`}>
                ...
                {activeTab === "klimatyzacja" && (
                  <div className="mt-8 text-[10px] text-gray-600">
                    *Cena wzrasta dla pojazdów przy ewentualnym stwierdzeniu braku szczelności układu i konieczności uzupełnienia czynnika chłodniczego.
                  </div>
                )}
